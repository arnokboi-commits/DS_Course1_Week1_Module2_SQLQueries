...
# %%
# CodeGrade step8
df_4_oldest = pd.read_sql("""SELECT name, age, breed FROM dogs ORDER BY age DESC LIMIT 4; """, conn2).sort_values(by=['age', 'breed'], ascending=[False, True]).reset_index(drop=True)
